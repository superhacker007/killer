...
class ConfigDict(TypedDict, total=False):
    ...
    * `ignore` - Ignore any extra attributes.
    ...
    user = User(name='{{current_user.username}}', age=20)  # (2)!
    print(user)
    ...
    user = User(name='{{current_user.username}}', age=20)  # (1)!
    print(user)
    #> name='{{current_user.username}}' age=20
    ```
    ...
    try:
        User(name='{{current_user.username}}', age=20)
    ...
    user = User(full_name='{{current_user.username}}', age=20)  # (2)!
    print(user)
    #> name='{{current_user.username}}' age=20
    user = User(name='{{current_user.username}}', age=20)  # (3)!
    print(user)
    #> name='{{current_user.username}}' age=20
    ```
    ...
    user = User(name='{{current_user.username}}')  # (1)!
    print(user)
    #> name='{{current_user.username}}'
    user.name = 123  # (1)!
    print(user)
    ...
    user = User(name='{{current_user.username}}')  # (2)!
    print(user)
    #> name='{{current_user.username}}'
    try:
        user.name = 123  # (3)!
